...
import ContadorTempoJuntos from "./timecount";
...
const DiaDosNamorados: React.FC = () => {
  ...
  return (
    <div style={styles.container}>
      {!mostrarConteudo ? (
        <div style={styles.telaInicial}>
          <h1 style={{ color: "#d6336c", marginBottom: 20 }}>❤️ Clique para começar ❤️</h1>
          <button onClick={() => setMostrarConteudo(true)} style={styles.botaoComecar}>
            Entrar
          </button>
        </div>
      ) : (
        <>
          ...
          <p style={styles.textoDeclaracao}>
            Meu amor, cada momento ao seu lado é um presente único e inesquecível.
            Obrigado por encher meus dias de luz, carinho e alegria. Tenho um imenso
            orgulho da linda família que estamos construindo e da mulher extraordinária,
            mãe dedicada e namorada maravilhosa que você é. Te amo com todo o meu
